...
class interface(instrument):
    ...
    def __init__(self, parent, root):
        ...
        self.StoredPowers =[] # List to store recorded powers
    ...
    def CreatePanelGUI(self,master):    
        ...
        self.frame = tk.LabelFrame(self.master,text="Thorlabs Powermeter ")
        ...
        self.ButtonSetZeroPowermeter.configure(state='disabled') 
        ...
        self.labelPowerOscillations = tk.Label(self.frame, text="Fluctuation in last 10 acquisitions",font=("Helvetica", 10))
        self.labelPowerOscillations.grid(row=5,column=0, sticky=tk.W,pady=3,padx=5)
        
        self.PowerFluctuationString =  tk.StringVar()
        self.labelPowerFluctuation = tk.Label(self.frame, textvariable=self.PowerFluctuationString, font=("Helvetica", 18),width=7, anchor="e")
        self.labelPowerFluctuation.grid(row=5,column=1, sticky=tk.N+tk.S+tk.E+tk.W,pady=3,padx=5,columnspan=2)
    ...
    def UpdatePower(self):
        ...
        if(self.ContinuousRead == 1):
            ...
            self.StoredPowers.append(self.currentPower)
    ...
    def SetZeroPowermeter(self):
        if(self.instrument.connected == 1): # If connected
            self.instrument.SetZero()
        return
    ...
    def SetWidgetsToConnectedState(self):
        ...
        self.ButtonSetZeroPowermeter.configure(state='active') 
