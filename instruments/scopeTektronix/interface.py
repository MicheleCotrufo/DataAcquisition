...
class interface(instrument):
    ...
    def CreatePanelGUI(self,ContainingFrame):    
        ...
        self.ButtonExplanationChannels = tk.Button(self.frameInputChannels, text="?", width=3, command=self.ExplanationChannels)
        ...
        self.ButtonExplanationRefreshRate = tk.Button(self.frame, text="?", width=3, command=self.ExplanationRefreshRate)
        ...
        self.ButtonExplanationBooster = tk.Button(self.frameBoost, text="?", width=3, command=self.ExplanationBooster)
